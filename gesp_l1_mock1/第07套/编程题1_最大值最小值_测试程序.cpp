// =============================================================
// GESP C++ 一级 模拟卷 第 07 套 - 编程题 1《求最大值与最小值》评测程序
//   g++ 你的代码.cpp -o my_answer
//   g++ 编程题1_最大值最小值_测试程序.cpp -o judge
...
static string solve(vector<int>&a){ int mx=a[0],mn=a[0]; for(int x:a){mx=max(mx,x);mn=min(mn,x);} return to_string(mx)+" "+to_string(mn); }
...
int main(int argc,char**argv){
    ...
    string exe=argv[1];
    vector<vector<int>> data={ {3,7,1,9,4},{-5,-2,-8},{42},{0,0,0},{1000000,-1000000},
        {5,4,3,2,1},{1,2,3,4,5},{-1,5,-3,8,-9},{100,100,99},{7,7,7,7} };
