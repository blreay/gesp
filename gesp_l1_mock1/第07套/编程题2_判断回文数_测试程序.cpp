// =============================================================
// GESP C++ 一级 模拟卷 第 07 套 - 编程题 2《判断回文数》评测程序
//   g++ 你的代码.cpp -o my_answer
//   g++ 编程题2_判断回文数_测试程序.cpp -o judge2
//   ./judge2 ./my_answer
...
static string solve(long long N){ long long t=N,r=0; while(t>0){r=r*10+t%10;t/=10;} return r==N?"YES":"NO"; }
int main(int argc,char**argv){
    if(argc<2){printf("用法: %s <考生可执行文件路径>\n",argv[0]);return 1;}
    string exe=argv[1];
    vector<long long> ins={121,123,7,1331,10,1,12321,2000000000LL,1000000001LL,98789};
