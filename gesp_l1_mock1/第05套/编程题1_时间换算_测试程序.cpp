// =============================================================
// GESP C++ 一级 模拟卷 第 05 套 - 编程题 1《时间换算》评测程序
//   g++ 你的代码.cpp -o my_answer
//   g++ 编程题1_时间换算_测试程序.cpp -o judge
...
static string solve(long long s){ return to_string(s/3600)+" "+to_string(s%3600/60)+" "+to_string(s%60); }
int main(int argc,char**argv){
    if(argc<2){printf("用法: %s <考生可执行文件路径>\n",argv[0]);return 1;}
    string exe=argv[1];
    vector<long long> ins={3661,90,0,59,3600,7200,86399,1,1000000,3599};
