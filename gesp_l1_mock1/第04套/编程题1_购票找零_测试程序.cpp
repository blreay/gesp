// =============================================================
// GESP C++ 一级 模拟卷 第 04 套 - 编程题 1《购票找零》评测程序
//   g++ 你的代码.cpp -o my_answer
//   g++ 编程题1_购票找零_测试程序.cpp -o judge
...
static string solve(long long m){ return to_string(m/45)+" "+to_string(m%45); }
int main(int argc,char**argv){
    if(argc<2){printf("用法: %s <考生可执行文件路径>\n",argv[0]);return 1;}
    string exe=argv[1];
    vector<long long> ins={100,45,1,44,90,1000000,449,450,99999,225};
