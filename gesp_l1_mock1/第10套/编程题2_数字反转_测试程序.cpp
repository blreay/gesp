// =============================================================
// GESP C++ 一级 模拟卷 第 10 套 - 编程题 2《数字反转》评测程序
//   g++ 你的代码.cpp -o my_answer
//   g++ 编程题2_数字反转_测试程序.cpp -o judge2
//   ./judge2 ./my_answer
...
static string solve(long long N){ long long r=0; while(N>0){r=r*10+N%10;N/=10;} return to_string(r); }
int main(int argc,char**argv){
    if(argc<2){printf("用法: %s <考生可执行文件路径>\n",argv[0]);return 1;}
    string exe=argv[1];
    vector<long long> ins={1234,1200,7,10,100,2000000000LL,1000000001LL,5060,90,123456789LL};
